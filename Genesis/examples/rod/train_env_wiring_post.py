...
class Train_Env_Wiring_post(Train_Env):
    def __init__(self, task='wiring', log_dir="xxx/wiring", n_envs=5, GUI=False):
        ...
        # RL/vectorized env configuration (align with Train_Env_Wiring_ring)
        self._backend = 'numpy'
    ...
    def reset_all(self, env_mask, state=None):
        ...
        fixed_ring1 = np.zeros((self.n_envs, self.stick1.n_vertices), dtype=bool)
        fixed_ring1[:, :] = True
        self.stick1.set_fixed(0, fixed_ring1)
        fixed_ring2 = np.zeros((self.n_envs, self.stick2.n_vertices), dtype=bool)
        fixed_ring2[:, :] = True
        self.stick2.set_fixed(0, fixed_ring2)
