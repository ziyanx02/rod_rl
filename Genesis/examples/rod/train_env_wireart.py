...
class Train_Env_Wireart(Train_Env):
    def __init__(self, task='wiring', log_dir="xxx/wiring", n_envs=5, GUI=False):
        ...
        # RL/vectorized env configuration (mirrors Train_Env_Wiring_ring structure)
        self._backend = 'numpy'

        # Observation / action specs
        self._obs_dim = 45 * 3  # n_vertices * 3 (matches rope n_vertices below)
    ...
    def construct_scene(self):
        ...
        self._rope_base_pos = np.array([-0.04, 0.0, 0.02], dtype=np.float32)
